...
var web3 = new Web3(
    new Web3(new Web3.providers.WebsocketProvider('ws://172.16.0.104:8546'))
);
...
var RequestVerifyId = econtract.events.RequestVerifyId({
     ...
     * Call storeID API
     */
    storeID('CC_PT', '0xE33C85c506F54fa369e7858bd698962fF8443A57', (err, data) => {
      var verifyID = web3.utils.toHex(data);
      /**
